...
parser.add_argument("--input_path", type=str, default="/data/DFO_wang/eval/data/nq_open/nq-open-oracle.json")
parser.add_argument("--output_path", type=str, default="data/Llama_3_8B_Residual_all_early_stop_3_iter5_step2_with_nq_attention_score.json")
parser.add_argument("--model_path", type=str, default="/data/DFO_wang/saves/Llama_3_8B_Residual_all_early_stop_3_iter5_step2")
...
with torch.no_grad():
    ...
    # 准备好所有待处理的文本
    contexts = [item['ctxs'][0]['text'] for item in data]
