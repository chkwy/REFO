...
def load_data(path):
    ...
    for i in data:
        premises_chosen.append(sentencize(i['chosen']['value']))
        # premises_chosen.append(sentencize(i['output']))
        # premises_rejected.append(sentencize(i['output']))
        premises_rejected.append(sentencize(i['rejected']['value']))

        # hypothesis.append(sentencize(output))
