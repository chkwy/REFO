...
parser.add_argument("--input_path", type=str, default="/data/DFO_wang/data/Llama_3_8B_only_iteration_DFO_data.json")
parser.add_argument("--output_path", type=str, default="/data/DFO_wang/data/Llama_3_8B_only_iteration_DFO_data_with_attention_score_1.json")
...
with torch.no_grad():
    ...
    for i in range(0, total_samples, BATCH_SIZE):
        ...
        del inputs, outputs, batch_attentions
        gc.collect()
