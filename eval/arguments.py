...
def get_args():
    ...
    # model
    parser.add_argument('--base_model', type=str, default='', help='base model id')
    ...
    # others
    parser.add_argument('--out-seq-len', type=int, default=2048)
    parser.add_argument('--num-ctx', type=int, default=5)
    parser.add_argument('--max-tokens', type=int, default=5096)
